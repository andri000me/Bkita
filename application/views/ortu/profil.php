    ...
    <div class="col-md-6">
      <div class="box box-widget widget-user-2">
        <div class="widget-user-header bg-aqua-active">
          ...
          <h3 class="widget-user-username"><?= $profil->nama_ortu ?></h3>
          <h5 class="widget-user-desc">
            <?php if ($profil->level == 3): ?>
              Orang Tua
            <?php endif ?>
          </h5>
        </div>
        <div class="box-footer no-padding">
          <ul class="nav nav-stacked">
            <li><a href="#">User ID <b class="pull-right"><?= $profil->id_ortu ?></b></a></li>
            <li><a href="#">Email <b class="pull-right"><?= $profil->email_ortu ?></b></a></li>
            <li><a href="#">Telepon <b class="pull-right"><?= $profil->telepon ?></b></a></li>
          ...
          <div class="tab-pane active" id="settings">
            <form class="form-horizontal" id="form-profil">
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" name="id_user" class="form-control" readonly value="<?= $profil->id_ortu ?>">
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label">Nama</label>
                <div class="col-sm-10">
                  <input type="text" name="nama" class="form-control" value="<?= $profil->nama_ortu ?>">
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label">Email</label>
                <div class="col-sm-10">
                  <input type="email" name="email"class="form-control" value="<?= $profil->email_ortu ?>">
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label">Telepon</label>
                <div class="col-sm-10">
                  <input type="text" data-mask="+6299999999999" class="form-control" id="phone" name="telepon" value="<?= $profil->telepon ?>">
                </div>
              </div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="form-group">
            ...
            <input type="hidden" name="id_user" value="<?= $profil->id_ort
            u ?>">
