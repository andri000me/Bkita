            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  ...
                  <small>Penanggung Jawab Siswa</small>
                </p>
              </li>
              <!-- Menu Footer-->
              <li class="user-footer">
                <div class="pull-left">
                  <a href="<?= base_url('ortu/profil') ?>" class="btn btn-default btn-flat">Profil</a>
                </div>
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        ...
        <div class="pull-left info">
          ...
          <p class="text-yellow small">Orang Tua</p>
        </div>
      </div>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?= base_url('ortu/datasiswa') ?>"><i class="fa fa-circle-o"></i> Data Anak</a></li>
            <li><a href="<?= base_url('ortu/pelanggaran') ?>"><i class="fa fa-circle-o"></i> Data Pelanggaran</a></li>
          </ul>
        </li>

        <li class="">
          <a href="<?= base_url('ortu/datapanggilan') ?>">
