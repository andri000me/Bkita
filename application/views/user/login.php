...
<head>
  ...
  <title>B-Kita SMK Negeri 1 Solok | Masuk</title>
  ...
  <div class="login-box-body">
    ...
    <?php elseif (isset($_GET['berhasil'])): ?>
      <div class="alert alert-success">
        <i class="icon fa fa-check-circle"></i> Akun Berhasil Dibuat, ID User Kamu <b><?= $_GET['berhasil'] ?></b>
      </div>
    <?php endif ?>
    ...
    Belum punya akun ? <a href="<?= base_url('user/daftar') ?>" class="text-center">Daftar sekarang</a>
